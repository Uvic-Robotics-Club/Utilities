...
class MainScreen(QtGui.QMainWindow):
    ...
    def SliderChanged(self,horizontalSlider):
        ...
        self.lcdNumber_3.display(degrees(self.arm.q3)+180)
        self.lcdNumber_4.display(degrees(self.arm.q4))
        index = 2
        self.x_y_z_label.setText("x: {:.2f} y: {:.2f} z: {:.2f}".format(
                                                                self.arm.x_joints[index],
                                                                self.arm.y_joints[index],
                                                                self.arm.z_joints[index]))
