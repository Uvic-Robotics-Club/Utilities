...
def animate(n):
	"""
	This function is called by the animation library from matplotlib.

	Parameters
	----------
	n : integer
		index into array so you can step though it
...
ani=animation.FuncAnimation(Figure, animate, range(1, Nt-1), interval = 10)
